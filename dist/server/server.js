...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./assets/_tanstack-start-manifest_v-C8D30LJ5.js");
    case VIRTUAL_MODULES.serverFnManifest:
      return await import("./assets/_tanstack-start-server-fn-manifest_v-CHvndpiZ.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-DZheszii.js").then((n) => n.r);
    }
    if (startEntry === null) {
      startEntry = await import("./assets/start-BxhOkh-F.js");
    }
    return {
      startEntry,
      routerEntry
